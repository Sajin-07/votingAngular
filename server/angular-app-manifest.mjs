...
export default {
  ...
  baseHref: '/datasoft-voting-system/',
  locale: undefined,
  routes: [
  {
    "renderMode": 2,
  ...
  assets: {
    ...
    'step5/index.html': {size: 48984, hash: '05c78562ca74b02ce04afce8ed78f58582e7d4a6e27edf5b461d269acc8e6450', text: () => import('./assets-chunks/step5_index_html.mjs').then(m => m.default)},
    'step2/index.html': {size: 50463, hash: 'c58820d769a3af963b28a73d211db38b41129d88406799aea2f50eb0392bee0a', text: () => import('./assets-chunks/step2_index_html.mjs').then(m => m.default)},
    'adminLogin/index.html': {size: 51193, hash: 'f4749ef4a47dcf6fc0de5d23a5afaebfe866b997950a5b73a82bea26d1c35417', text: () => import('./assets-chunks/adminLogin_index_html.mjs').then(m => m.default)},
